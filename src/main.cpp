...
Camera camera(glm::vec3(0.0f, 3.0f, 0.0f), glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.0f, 1.0f, 0.0f), 45.0f, (float)WIDTH / (float)HEIGHT, 0.1f, 50.0f);
...
int main()
{
    ...
    Cube cube(Tetris3D.shaderProgram, &camera, glm::vec3(1.0f, 0.0f, 0.0f));
...
void keyCallback(GLFWwindow *window, int key, int scancode, int action, int mods)
{
    ...
    // {
    //     camera.moveVerticalOnCircle(20.0f * glfwGetTime());
    // }
